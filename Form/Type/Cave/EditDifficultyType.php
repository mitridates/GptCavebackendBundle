...
use App\GptCaveBundle\Entity\Cavedifficulty;
...
class EditDifficultyType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $defaults)
    {
        ...
        $builder->add('difficulty', EntityType::class, array(
                    'class'=>'GptCaveBundle:Fieldvaluecode',
                    'attr'=>array('code_id'=>50, 'class'=>'select2', 'style'=>'width:100%'),
                    'required' => true,
                    'choice_label' => 'value',
                    'choice_value'=>'id',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'App\GptCaveBundle\Entity\Cavedifficulty',
            'parameters'=>array(),
